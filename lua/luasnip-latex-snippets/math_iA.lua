...
function M.retrieve(is_math)
  ...
  return {
    ...
    partse_snippet({ trig = "Alp", name = "Alpha", priority = 200}, "\\Alpha "),
    partse_snippet({ trig = "Bet", name = "Beta", priority = 200}, "\\Beta "),
    partse_snippet({ trig = "Chi", name = "Chi", priority = 200}, "\\Chi "),
    partse_snippet({ trig = "Del", name = "Delta", priority = 200}, "\\Delta "),
    partse_snippet({ trig = "Eps", name = "Epsilon", priority = 200}, "\\Epsilon "),
    partse_snippet({ trig = "Gam", name = "Gamma", priority = 200}, "\\Gamma "),
    partse_snippet({ trig = "Iot", name = "Iota", priority = 200}, "\\Iota "),
    partse_snippet({ trig = "Kap", name = "Kappa", priority = 200}, "\\Kappa "),
    partse_snippet({ trig = "Lam", name = "Lambda", priority = 200}, "\\Lambda "),
    partse_snippet({ trig = "Mu", name = "Mu", priority = 200}, "\\Mu "),
    partse_snippet({ trig = "Nu", name = "Nu", priority = 200}, "\\Nu "),
    partse_snippet({ trig = "Ome", name = "Omega", priority = 200}, "\\Omega "),
    partse_snippet({ trig = "Phi", name = "Phi", priority = 200}, "\\Phi "),
    partse_snippet({ trig = "Pi", name = "Pi", priority = 200}, "\\Pi "),
    partse_snippet({ trig = "Psi", name = "Psi", priority = 200}, "\\Psi "),
    partse_snippet({ trig = "Rho", name = "Rho", priority = 200}, "\\Rho "),
    partse_snippet({ trig = "Sig", name = "Sigma", priority = 200}, "\\Sigma "),
    partse_snippet({ trig = "Tau", name = "Tau", priority = 200}, "\\Tau "),
    partse_snippet({ trig = "The", name = "Theta", priority = 200}, "\\Theta "),
    partse_snippet({ trig = "Zet", name = "Zeta", priority = 200}, "\\Zeta "),
    partse_snippet({ trig = "Eta", name = "Eta", priority = 200}, "\\Eta "),

    partse_snippet({ trig = "alp", name = "alpha", priority = 200}, "\\alpha "),
    partse_snippet({ trig = "bet", name = "beta", priority = 200}, "\\beta "),
    partse_snippet({ trig = "chi", name = "chi", priority = 200}, "\\chi "),
    partse_snippet({ trig = "del", name = "delta", priority = 200}, "\\delta "),
    partse_snippet({ trig = "eps", name = "epsilon", priority = 200}, "\\vareps "),
    partse_snippet({ trig = "gam", name = "gamma", priority = 200}, "\\gamma "),
    partse_snippet({ trig = "iot", name = "iota", priority = 200}, "\\iota "),
    partse_snippet({ trig = "kap", name = "kappa", priority = 200}, "\\kappa "),
    partse_snippet({ trig = "lam", name = "lambda", priority = 200}, "\\lambda "),
    partse_snippet({ trig = "mu", name = "mu", priority = 200}, "\\mu "),
    partse_snippet({ trig = "nu", name = "nu", priority = 200}, "\\nu "),
    partse_snippet({ trig = "ome", name = "omega", priority = 200}, "\\omega "),
    partse_snippet({ trig = "phi", name = "phi", priority = 200}, "\\phi "),
    partse_snippet({ trig = "pi", name = "pi", priority = 200}, "\\pi "),
    partse_snippet({ trig = "psi", name = "psi", priority = 200}, "\\psi "),
    partse_snippet({ trig = "rho", name = "rho", priority = 200}, "\\rho "),
    partse_snippet({ trig = "sig", name = "sigma", priority = 200}, "\\sigma "),
    partse_snippet({ trig = "tau", name = "tau", priority = 200}, "\\tau "),
    partse_snippet({ trig = "the", name = "theta", priority = 200}, "\\theta "),
    partse_snippet({ trig = "zet", name = "zeta", priority = 200}, "\\zeta "),
    partse_snippet({ trig = "eta", name = "eta", priority = 200}, "\\eta "),

    partse_snippet({ trig = "siw", name = "sigmaw2", priority = 200}, "\\sigma_w^2 "),
